# dual-roi-system - Task 3.1

Execute task 3.1 for the dual-roi-system specification.

## Task Description
Extend ROI capture service in backend/app/core/roi_capture.py

## Code Reuse
**Leverage existing code**: existing RoiCaptureService class, PIL image processing
...
## Usage
```
/Task:3.1-dual-roi-system
```

## Instructions

Execute with @spec-task-executor agent the following task: "Extend ROI capture service in backend/app/core/roi_capture.py"

```
Use the @spec-task-executor agent to implement task 3.1: "Extend ROI capture service in backend/app/core/roi_capture.py" for the dual-roi-system specification and include all the below context.
...
## Task Details
- Task ID: 3.1
- Description: Extend ROI capture service in backend/app/core/roi_capture.py
- Leverage: existing RoiCaptureService class, PIL image processing
- Requirements: 2.2, 3.1

## Instructions
- Implement ONLY task 3.1: "Extend ROI capture service in backend/app/core/roi_capture.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks dual-roi-system 3.1 --mode complete
...
```bash
claude-code-spec-workflow get-tasks dual-roi-system 3.1 --mode complete
```
