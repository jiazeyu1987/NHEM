# dual-roi-system - Task 3.2

Execute task 3.2 for the dual-roi-system specification.

## Task Description
Add dual-ROI validation and error handling in backend/app/core/roi_capture.py

## Code Reuse
**Leverage existing code**: existing error handling patterns, logging utilities

## Requirements Reference
**Requirements**: 2.3, Reliability requirements

## Usage
```
/Task:3.2-dual-roi-system
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add dual-ROI validation and error handling in backend/app/core/roi_capture.py"

```
Use the @spec-task-executor agent to implement task 3.2: "Add dual-ROI validation and error handling in backend/app/core/roi_capture.py" for the dual-roi-system specification and include all the below context.
...
## Task Details
- Task ID: 3.2
- Description: Add dual-ROI validation and error handling in backend/app/core/roi_capture.py
- Leverage: existing error handling patterns, logging utilities
- Requirements: 2.3, Reliability requirements

## Instructions
- Implement ONLY task 3.2: "Add dual-ROI validation and error handling in backend/app/core/roi_capture.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks dual-roi-system 3.2 --mode complete
...
```bash
claude-code-spec-workflow get-tasks dual-roi-system 3.2 --mode complete
```
