# dual-roi-system - Task 7.1

Execute task 7.1 for the dual-roi-system specification.

## Task Description
Update fem_config.json schema in backend/app/fem_config.json

## Code Reuse
**Leverage existing code**: existing configuration structure, JSON schema validation
...
## Usage
```
/Task:7.1-dual-roi-system
```

## Instructions

Execute with @spec-task-executor agent the following task: "Update fem_config.json schema in backend/app/fem_config.json"

```
Use the @spec-task-executor agent to implement task 7.1: "Update fem_config.json schema in backend/app/fem_config.json" for the dual-roi-system specification and include all the below context.
...
## Task Details
- Task ID: 7.1
- Description: Update fem_config.json schema in backend/app/fem_config.json
- Leverage: existing configuration structure, JSON schema validation
- Requirements: 1.4, 1.5

## Instructions
- Implement ONLY task 7.1: "Update fem_config.json schema in backend/app/fem_config.json"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks dual-roi-system 7.1 --mode complete
...
```bash
claude-code-spec-workflow get-tasks dual-roi-system 7.1 --mode complete
```
