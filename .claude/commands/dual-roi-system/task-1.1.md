# dual-roi-system - Task 1.1

Execute task 1.1 for the dual-roi-system specification.

## Task Description
Create dual-ROI data models in backend/app/models.py

## Code Reuse
**Leverage existing code**: existing RoiConfig, RoiData, RoiFrame classes
...
## Usage
```
/Task:1.1-dual-roi-system
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create dual-ROI data models in backend/app/models.py"

```
Use the @spec-task-executor agent to implement task 1.1: "Create dual-ROI data models in backend/app/models.py" for the dual-roi-system specification and include all the below context.
...
## Task Details
- Task ID: 1.1
- Description: Create dual-ROI data models in backend/app/models.py
- Leverage: existing RoiConfig, RoiData, RoiFrame classes
- Requirements: 1.1, 1.2

## Instructions
- Implement ONLY task 1.1: "Create dual-ROI data models in backend/app/models.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks dual-roi-system 1.1 --mode complete
...
```bash
claude-code-spec-workflow get-tasks dual-roi-system 1.1 --mode complete
```
