# dual-roi-system - Task 8.4

Execute task 8.4 for the dual-roi-system specification.

## Task Description
Add fetchDualRoiFrame() function in front/index.html

## Code Reuse
**Leverage existing code**: existing fetchData() function pattern
...
## Usage
```
/Task:8.4-dual-roi-system
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add fetchDualRoiFrame() function in front/index.html"

```
Use the @spec-task-executor agent to implement task 8.4: "Add fetchDualRoiFrame() function in front/index.html" for the dual-roi-system specification and include all the below context.
...
## Task Details
- Task ID: 8.4
- Description: Add fetchDualRoiFrame() function in front/index.html
- Leverage: existing fetchData() function pattern
- Requirements: 4.3, 5.3

## Instructions
- Implement ONLY task 8.4: "Add fetchDualRoiFrame() function in front/index.html"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks dual-roi-system 8.4 --mode complete
...
```bash
claude-code-spec-workflow get-tasks dual-roi-system 8.4 --mode complete
```
